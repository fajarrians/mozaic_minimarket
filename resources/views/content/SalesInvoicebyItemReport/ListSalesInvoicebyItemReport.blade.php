...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
            ...
            <table id="myDataTable" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th style='text-align:center; width: 20%'>Jumlah Barang</th>
                        <th style='text-align:center; width: 20%'>Jumlah Penjualan</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
    ...
    <div class="card-footer text-muted">
        <div class="form-actions float-right">
            <a class="btn btn-secondary" href="{{ url('sales-invoice-by-item-report/print') }}"><i class="fa fa-file-pdf"></i> Pdf</a>
            <a class="btn btn-dark" href="{{ url('sales-invoice-by-item-report/export') }}"><i class="fa fa-download"></i> Export Data</a>
        </div>
    </div>
  </div>
</div>
